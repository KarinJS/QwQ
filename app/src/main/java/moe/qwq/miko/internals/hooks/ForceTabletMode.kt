...
import com.tencent.qqnt.kernelpublic.nativeinterface.InitSessionConfig
...
class ForceTabletMode: IAction {
    ...
    override fun onRun(ctx: Context) {
        ...
        val deviceTypeField = InitSessionConfig::class.java.declaredFields.firstOrNull {
            it.type == com.tencent.qqnt.kernelpublic.nativeinterface.DeviceType::class.java
        }
        if (deviceTypeField != null) {
            XposedBridge.hookAllConstructors(InitSessionConfig::class.java, afterHook {
                ...
                deviceTypeField.set(it.thisObject, com.tencent.qqnt.kernelpublic.nativeinterface.DeviceType.KPAD)
            })
        }
        InitSessionConfig::class.java.hookMethod("getDeviceType").after {
            it.result = com.tencent.qqnt.kernelpublic.nativeinterface.DeviceType.KPAD
        }
